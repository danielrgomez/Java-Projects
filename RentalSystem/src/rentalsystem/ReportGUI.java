...
public class ReportGUI extends javax.swing.JFrame {
    ...
    public ReportGUI() {
        ...
        m1.clear();
        LinkedList<Customer> customers = RentalSystem.getCustomers();
        for(int i=0; i < customers.size(); i++) {
            m1.addElement( customers.get(i).toString() );
        }
        
        DefaultListModel m2 = (DefaultListModel)(jList2.getModel());
        m2.clear();
        LinkedList<RentalItem> items = RentalSystem.getItems();
        for(int i=0; i < items.size(); i++) {
            m2.addElement( items.get(i).toString() );
        }
    }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Sort by Address");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Collections.sort(RentalSystem.getCustomers());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Collections.sort(RentalSystem.getCustomers(), new CustomerComparatorById());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Collections.sort(RentalSystem.getCustomers(), new CustomerComparatorByAddr());
